...
test "$VER3" != "3.7.14" && patch sqlite3/src/libshell.c <<'EOD'
...
@@ -14,6 +14,7 @@
 **
 ** $Id: mingw64-cross-build.sh,v 1.29 2012/09/04 04:55:29 chw Exp chw $
 */
